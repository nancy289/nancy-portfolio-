...
const PORTFOLIO_DATA = {
  ...
  about: {
    ...
    professionalSummary:
      "Quality Assurance Engineer with hands-on experience testing responsive web applications, APIs and complex user workflows. Skilled in creating structured test cases, identifying high-impact defects and communicating findings clearly with developers and stakeholders.",
    careerObjective:
      "To contribute to a quality-driven engineering team where I can strengthen product reliability, expand automation knowledge and help deliver experiences users can trust.",
    philosophy:
